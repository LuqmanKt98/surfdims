            ...
            <div className="container mx-auto px-4 lg:px-6 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    <button 
                        ...
                        className="px-4 md:px-6 py-2 bg-[#49b9ce] text-white font-semibold rounded-lg shadow-md hover:bg-[#41a5b9] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#02325a] focus:ring-[#49b9ce] transition duration-150 ease-in-out disabled:opacity-60 disabled:cursor-not-allowed"
                    ...
                    <div className="relative" ref={helpDropdownRef}>
                         <button onClick={() => setIsHelpDropdownOpen(!isHelpDropdownOpen)} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#02325a] focus:ring-cyan-400 rounded-full">
                    ...
                    {currentUser ? (
                        <div className="relative" ref={userDropdownRef}>
                            <button onClick={() => setIsUserDropdownOpen(!isUserDropdownOpen)} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#02325a] focus:ring-cyan-400 rounded-full">
                                {currentUser.avatar ? (
                                    <img src={currentUser.avatar} alt="User Avatar" className="h-10 w-10 rounded-full object-cover" />
                                ) : (
                                    <UserIcon className="h-10 w-10 p-2 rounded-full bg-slate-200 text-[#02325a]" />
                                )}
                            </button>
                            {isUserDropdownOpen && (
                                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-xl z-20 py-1">
                        ...
                        <button 
                            ...
                            className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#02325a] focus:ring-cyan-400 rounded-full"
                        >
                            <UserIcon className="h-10 w-10 p-2 rounded-full bg-slate-200 text-[#02325a]" />
                        </button>
                    )}
